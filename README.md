...
主题组之间是 OR 关系：文献只要命中任意一个启用主题，就会被视为主题相关，不需要同时命中出版主题和管理学迁移主题。

例如 `management_transfer` 是独立入口，组织能力、动态能力、资源基础观、品牌资产、平台治理、数字化转型等文章，即使没有出现“出版”“期刊”“编辑”等关键词，也不会因此被标记为 `uncategorized`。质量门仍然保持严格，主题命中只代表进入候选判断，不代表自动推送。
